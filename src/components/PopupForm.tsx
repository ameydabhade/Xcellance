    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg p-6 w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-blue-600">Book Your Appointment</h2>
        ...
        <div className="bg-blue-600 text-white p-3 rounded-lg mb-4 text-center">
          <p className="text-sm mb-1">⏰ This offer expires in:</p>
          <div className="text-2xl font-bold">
            {minutes.toString().padStart(2, '0')}:{seconds.toString().padStart(2, '0')}
          </div>
          <p className="text-xs mt-1">Book within the next 20 minutes for guaranteed Free Consultation</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="tel" required className="w-full p-2 border border-gray-300 rounded-lg" />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea required rows={2} placeholder="Briefly describe your dental issue" className="w-full p-2 border border-gray-300 rounded-lg"></textarea>
          </div>
          <div>
            <label className="block text-sm font-medium mb-1">Preferred Date</label>
            <input type="date" required className="w-full p-2 border border-gray-300 rounded-lg" />
          </div>
          <div>
